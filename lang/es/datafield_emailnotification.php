...
/**
 * Strings for component 'datafield_emailnotification', language 'en', branch 'master'
 *
...
$string['pluginname'] = 'Notificación de correo electrónico';
$string['fieldtypelabel'] = 'Notificación de correo electrónico';
